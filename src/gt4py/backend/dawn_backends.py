...
class SIRConverter(gt_ir.IRNodeVisitor):
    @classmethod
    def apply(cls, impl_node: gt_ir.StencilImplementation):
        return cls()(impl_node)
...
class DawnPyExtGenerator(gt_backend.GTPyExtGenerator):
    ...
    def __call__(self, impl_node: gt_ir.StencilImplementation):
        ...
        sir = SIRConverter.apply(impl_node)
...
class BaseDawnBackend(gt_backend.BaseGTBackend):
    ...
    PYEXT_GENERATOR_CLASS = DawnPyExtGenerator
